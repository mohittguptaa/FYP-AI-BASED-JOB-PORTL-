...
// const uri = `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASSWORD}@cluster0.mbd7y4d.mongodb.net/?retryWrites=true`;
const uri = `mongodb+srv://mohitgupta8218:0ropYrzianyRCyQy@cluster0.zvma8.mongodb.net/`;
